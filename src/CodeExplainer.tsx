  ...
  return (
    <div className="grid grid-cols-2 gap-4 h-[500px]">
      ...
      <div className="border rounded-lg p-6 bg-blue-50 relative">
        ...
        {loading ? <p>Thinking...</p> : <p className="text-slate-700 leading-relaxed">{explanation || "Click a line of code to see the AI explanation."}</p>}
      </div>
    </div>
  );
}